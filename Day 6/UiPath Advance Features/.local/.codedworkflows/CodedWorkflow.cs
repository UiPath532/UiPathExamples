...
namespace UiPathAdvanceFeatures
{
    ...
    {
        private Lazy<UiPathAdvanceFeatures.WorkflowRunnerService> _workflowRunnerServiceLazy;
        private Lazy<ConnectionsManager> _connectionsManagerLazy;
        public CodedWorkflow()
        {
            _ = new System.Type[]{typeof(UiPath.Testing.API.ITestingService), typeof(UiPath.Core.Activities.API.ISystemService), typeof(UiPath.Mail.Activities.Api.IMailService), typeof(UiPath.UIAutomationNext.API.Contracts.IUiAutomationAppService), typeof(UiPath.Excel.Activities.API.IExcelService)};
            _workflowRunnerServiceLazy = new Lazy<UiPathAdvanceFeatures.WorkflowRunnerService>(() => new UiPathAdvanceFeatures.WorkflowRunnerService(this.services));
#pragma warning disable
            _connectionsManagerLazy = new Lazy<ConnectionsManager>(() => new ConnectionsManager(serviceContainer));
#pragma warning restore
        }

        protected UiPathAdvanceFeatures.WorkflowRunnerService workflows => _workflowRunnerServiceLazy.Value;
